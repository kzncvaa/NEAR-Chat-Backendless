<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="chatXam">
    <folder name="{backendless-codegen/application/name}">
      <file path="backendless-codegen/Xamarin/Chat/RealTimeChat.sln"/>
      <folder name="XamarinMobile">
        <folder path="backendless-codegen/Xamarin/Chat/XamarinMobile/XamarinMobile"/>
        <folder path="backendless-codegen/Xamarin/Chat/XamarinMobile/XamarinMobile.Android"/>
        <folder path="backendless-codegen/Xamarin/Chat/XamarinMobile/XamarinMobile.iOS"/>
        <folder path="backendless-codegen/Xamarin/Chat/XamarinMobile/Backendless.NET.Standard20"/>
