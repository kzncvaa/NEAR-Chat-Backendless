<xsl:stylesheet version="1.0"
    ...
    <xsl:include href="./kotlin-util.xsl"/>
                        ...
                        <folder name="com">
                            <folder name="mbass">
                                <folder name="examples">
                                    <file name="Defaults.kt">package <xsl:value-of select="$package"/>;
...
object Defaults
{
  <xsl:call-template name="common-defaults"/>
                                    ...
                                    <file path="./files/MainActivity.kt"/>
                                </folder>
                            </folder>
                        </folder>
                    </folder>
                    <folder name="res">
                        <folder name="layout">
                            <file path="./files/main_activity.xml" />
                        </folder>
                    </folder>
                    <file path="./files/AndroidManifest.xml" />
                </folder>
            </folder>
